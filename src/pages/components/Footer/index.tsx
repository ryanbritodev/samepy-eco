export const Footer = () => {
  return (
    <>
      <div className="absolute -z-50 w-full h-[15vh] sm:h-[13vh] left-[0] bottom-[0] bg-primary-light-green "></div>
      <footer className="w-full flex flex-row justify-between items-center -mb-[1.5em] text-sm">
        ...
        <div className="flex flex-col">
          <h3 className="font-bold text-primary-dark-green hidden sm:flex">Nossas Redes</h3>
